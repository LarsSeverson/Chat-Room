...
class ExecuteCreateRoomButton(modules.QPushButton):
    def __init__(self):
        super().__init__()

        self.icon = modules.QIcon()
        self.icon.addPixmap(modules.QtGui.QPixmap("src/UI/assets/create.png"), modules.QtGui.QIcon.Normal, modules.QtGui.QIcon.Off)
...
class CreateRoomButton(modules.QPushButton):
    def __init__(self):
        super().__init__()
